    ...
    function VanillaCalendar(options) {
        ...
        const createCalendar = function () {
            ...
            <div class="vanilla-calendar-header">
                <button type="button" class="vanilla-calendar-btn" data-calendar-toggle="previous"><img src="../user/img/calendar-arrow.png" alt=""></button>
                <div class="vanilla-calendar-header__label" data-calendar-label="month"></div>
                <button type="button" class="vanilla-calendar-btn" data-calendar-toggle="next" style="transform: rotate(180deg);"><img src="../user/img/calendar-arrow.png" alt=""></button>
            </div>
