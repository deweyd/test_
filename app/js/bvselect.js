...
class BVSelect {
    ...
    }) 
    {
        ...
        this.CriarDivBase = function() {
            ...
            if (this.searchbox == true) {
                document.querySelector("#ul_" + randomID).insertAdjacentHTML('afterbegin', '<div class=""><div class="text-all">Все авторы</div><li class="nofocus"><div class="innerinput"><input placeholder="' + SearchPlaceholder + '" class="bv_input" id="input_' + randomID + '" type="text"></div</li></div>');
            }
