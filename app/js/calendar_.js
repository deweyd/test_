...
!function (e, t) {
    ...
    class e {
        constructor(e = {}) {
            ...
            if (this.CAL_NAME = "color-calendar", this.DAYS_TO_DISPLAY = 42, this.weekdayDisplayTypeOptions = {
                short: ["S", "M", "T", "W", "T", "F", "S"],
                "long-lower": ["ПН", "ВТ", "СР", "ЧТ", "ПТ", "СБ", "НД"],
                "long-upper": ["ПН", "ВТ", "СР", "ЧТ", "ПТ", "СБ", "НД"]
    ...
    return e.prototype.addEventListeners = function () {
        ...
        const t = parseInt(e.target.innerText), a = parseInt(e.target.dataset.value);
        ...
        const t = this.pickerType, a = e.target.classList;
        ...
        this.oldSelectedNode = null, this.customMonthValues ? this.monthDisplay.innerHTML = this.customMonthValues[this.currentDate.getMonth()] : this.monthDisplay.innerHTML = new Intl.DateTimeFormat("default", {month: this.monthDisplayType}).format(this.currentDate), this.yearDisplay.innerHTML = this.currentDate.getFullYear().toString()
        ...
        let t, a;
        t = e.target.parentElement.innerText, a = parseInt(t, 10), this.removeOldDaySelection(), t && (this.updateCurrentDate(0, a), Object.assign(this.daysIn_CurrentMonth[a - 1], {selected: !0}), this.rerenderSelectedDay(e.target.parentElement, a, !0))
        ...
        let e = 0;
        const t = this.currentDate.getFullYear(), a = this.currentDate.getMonth();
        let i;
        this.filteredEventsThisMonth = this.eventsData.filter(e => {
            ...
            const t = new Date(e.start).getDate(), a = new Date(e.end).getDate();
        ...
        let i = e.previousElementSibling, r = this.today.getFullYear() === this.currentDate.getFullYear(),
        ...
        return this.filteredEventsThisMonth.filter(t => {
            const a = new Date(t.start).getDate(), i = new Date(t.end).getDate();
