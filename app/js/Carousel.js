...
(function ($) {
    ...
    function scroll($container, direction) {
         ...
         */
        $container.find('.customer-slider ul li').each(function (index, element) {
    ...
    function initStyle($container) {
        ...
        $container.find('.customer-slider ul li img').css({
            width: "100%",
            height: "100%"
        });
        $container.find('.customer-slider ul').css({
            position: 'relative',
            width: listWidth,
    ...
    $.fn.carousel = function (param) {
        ...
        $(this).each(function(index, target) {
            ...
            if (typeof param === 'object' && param !== null) {
                ...
                totalNum = $target.find('.customer-slider ul li').length;
                ...
                (function($target) {
                    ...
                    if($target.data('config').autoPlay) {
                        ...
                        $target.find('.customer-slider ul').off('mouseenter').on('mouseenter', function() {
                            clearInterval($target.data('auto'));
                        ...
                        $target.find('.customer-slider ul').off('mouseenter').off('mouseleave');
                    }
                })($target);
            }
